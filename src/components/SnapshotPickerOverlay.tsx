    ...
    <>
      ...
      {selectableCandidates.map((c) => {
        ...
        return (
          <div
            key={c.id}
            ref={(el) => { if (el) candidateRefs.current.set(c.id, el); else candidateRefs.current.delete(c.id); }}
          ...
          >
            ...
            {(selected || isHovered) && (
              <PhysicsBadge
                ...
                wide={wide}
                isHovered={isHovered}
                onClick={(e) => { e.stopPropagation(); onToggleSelected(c.id); }}
            ...
            {c.saved ? (
              <SaveBadge
                ...
                isHovered={isHovered}
                isFlash={isFlash}
                onClick={(e) => { e.stopPropagation(); onUnsaveNode(c.id); }}
