...
import type { BlockedInterval, ObstacleRect } from "../scene/types"
import { getAvailableSegments, getBlockedIntervalsForRow, getObstacleAABB } from "./obstacles"
