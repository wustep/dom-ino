	...
	return {
		...
		elements: [
			...
			},
			{
				...
				throwable: false,
				pinned: true,
				text: "Physics-native layout engine",
				fontSize: 11,
				fontWeight: 400,
				fontFamily: DATA,
				lineHeight: 14,
			...
			},
			{
				...
				rect: {
					x: mx,
					y: dominoY,
					width: narrow ? Math.min(w, 260) : 340,
					height: narrow ? 62 : 78,
				},
				throwable: true,
				pinned: false,
			...
			},
			{
				...
				rect: {
					x: narrow ? mx : mx + 336,
					y: narrow ? priceY + 272 : priceY,
					width: narrow ? w : w - 336,
					height: 256,
				},
				throwable: true,
				pinned: false,
			...
			},
			{
				...
				throwable: false,
				pinned: true,
				text: "Layout that keeps its nerve.",
				fontSize: 12,
				fontWeight: 400,
				fontFamily: BODY,
				lineHeight: 16,
